...
@Configuration
@EnableJpaRepositories(basePackages = "com.AdvertisementMicroservice.AdvertisementMicroservice.Repositorys")
@EnableElasticsearchRepositories(basePackages="com.AdvertisementMicroservice.AdvertisementMicroservice.searchRepository")
